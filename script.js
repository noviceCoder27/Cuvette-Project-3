...
// Funciton to list all food items
...
const listVegetables = () => {
    const vegetables = allFoodItems.filter(item => item.category === "Vegetable");
...
const listFruits = () => {
    const fruits = allFoodItems.filter(item => item.category === "Fruit");
    console.log("Fruits: \n",fruits);
}
...
const listProtienFood = () => {
    const protienFood = allFoodItems.filter(item => item.category === "Protein");
    console.log("Protien Food: \n",protienFood);
}
...
const listNuts = () => {
    const nuts = allFoodItems.filter(item => item.category === "Nuts");
    console.log("Nuts: \n", nuts);
}

listNuts();

//Function to list all the food items with category grain

const listGrain = () => {
    const grain = allFoodItems.filter(item => item.category === "Grain");
    console.log("Grains: \n", grain);
}
...
const listDairyFood = () => {
    const dairyFood = allFoodItems.filter(item => item.category === "Dairy");
