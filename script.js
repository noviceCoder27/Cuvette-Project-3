...
const listVegetables = () => {
    const vegetables = foodItems.filter(item => item.category === "Vegetable");
...
const listFruits = () => {
    const fruits = foodItems.filter(item => item.category === "Fruit");
    console.log("Fruits: \n",fruits);
}
...
const listProtienFood = () => {
    const protienFood = foodItems.filter(item => item.category === "Protein");
...
const listNuts = () => {
    const nuts = foodItems.filter(item => item.category === "Nuts");
    console.log("Nuts: \n", nuts);
}
...
const listGrain = () => {
    const grain = foodItems.filter(item => item.category === "Grain");
    console.log("Grains: \n", grain);
}
...
const listDairyFood = () => {
    const dairyFood = foodItems.filter(item => item.category === "Dairy");
